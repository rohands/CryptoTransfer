package com.example.securetransfer.buyer;
...
import com.example.securetransfer.R;
import com.example.securetransfer.bluetooth.BluetoothReceive;
import com.example.securetransfer.bluetooth.BluetoothSend;
import com.example.securetransfer.callback.BuyerCallback;
import com.example.securetransfer.db.Other;
import com.example.securetransfer.db.Self;
import com.example.securetransfer.generator.Generator;
import com.example.securetransfer.main.Base;
import com.example.securetransfer.scanner.Scanner;
...
public class BuyerTransaction extends Activity {
	...
	final public void transactionPhase2() {
		...
		try {
			...
			Log.d("Error_updation", exception.toString());
			String errorMessage = "Error:" + exception;
			toast = Toast.makeText(this.context, errorMessage, duration);
			toast.setGravity(Gravity.BOTTOM | Gravity.LEFT, 400, 300);
			toast.show();
